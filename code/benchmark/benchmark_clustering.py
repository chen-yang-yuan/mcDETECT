...
4. Run Minibatch K-Means for a range of cluster numbers and record Silhouette score and inertia (elbow method).
5. Save metrics to a single CSV and visualize to help choose the optimal number of clusters.
"""
...
for k in k_range:
    ...
    results.append({"n_clusters": k, "inertia": inertia, "silhouette_score": sil})
    results.append({"n_clusters": k, "inertia": inertia})
