...
results_df.to_csv(output_dir + "p_l_benchmark_multi_marker_3D_detailed.csv", index=False)
print(f"Saved: {output_dir + 'p_l_benchmark_multi_marker_3D_detailed.csv'}")
...
mean_df.to_csv(output_dir + "p_l_benchmark_multi_marker_3D_mean.csv", index=False)
print(f"Saved: {output_dir + 'p_l_benchmark_multi_marker_3D_mean.csv'}")